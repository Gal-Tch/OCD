...
def wrapper_dataset(config, args, device):
    if args.datatype == 'tinynerf':
        ...
        train_dataset = LoadImagesAndLabels(path=".yolov7/coco/val2017.txt", batch_size=1, img_size=512,
        ...
        test_dataset = LoadImagesAndLabels(path=".yolov7/coco/val2017.txt", batch_size=1, img_size=512,
